...
[Creating Your First Substrate Chain Tutorial](/tutorials/create-your-first-substrate-chain/v2.0.0-alpha.8).
...
git clone -b v2.0.0-alpha.8 https://github.com/substrate-developer-hub/substrate-front-end-template
