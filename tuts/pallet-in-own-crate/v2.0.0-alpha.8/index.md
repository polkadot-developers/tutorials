...
From the above snippet, we see that this pallet template depends on version `2.0.0-alpha.8` of the
low-level libraries. Thus it can be used in runtimes that also depend on `2.0.0-alpha.8`.
